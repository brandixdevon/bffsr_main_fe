...
const headCells = [
  ...
  { id: 'pm_status', numeric: true, disablePadding: false, label: 'PM STATUS' }
];
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" style={{color:"purple",fontSize:"15px",fontWeight:"bold"}} component="div">
          SRF List For Update Pattern Making Details
        </Typography>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    <TableCell align="left">
                      ...
                      <TableCell align="left">{row.pm_status.replace(/"/g, "")}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
