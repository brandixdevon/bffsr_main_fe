...
import DataTable  from './allpmtable';
...
export default function Allsrf() {
  ...
  async function GetData ()
  {
    ...
    {
        Swal.fire({  title: 'Error!',  text: 'Please Select Pattern Making Status.',  icon: 'error',  confirmButtonText: 'OK'});
        return;
    }
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth={false} className={classes.container}>
          <Grid  style={{backgroundColor: 'white'}} container spacing={1}>
            ...
            <Grid item md={6}>
            <Typography variant="subtitle2" gutterBottom>Pattern Making Status</Typography>
            <MultiSelect
                  overrideStrings={{"allItemsAreSelected": "All Pattern Making Status are selected.","selectAll": "Select All Status"}}
