...
const headCells = [
  ...
  { id: 'pb_status', numeric: true, disablePadding: false, label: 'PB STATUS' }
];
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" style={{color:"purple",fontSize:"15px",fontWeight:"bold"}} component="div">
          SRF List For Update Placement Board Details
        </Typography>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    <TableCell align="left">
                      ...
                      <TableCell align="left">{row.pb_status.replace(/"/g, "")}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
