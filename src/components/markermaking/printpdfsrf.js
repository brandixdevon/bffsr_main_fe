        ...
        <PDFViewer title={VAL_SRFIDCLUSTER+VAL_SRFIDDATE+VAL_SRFIDSEQ} style={{width:"100%", height:"95vh"}}>
            ...
            <Document title={VAL_SRFIDCLUSTER+VAL_SRFIDDATE+VAL_SRFIDSEQ}>
                <Page size="A4" style={styles.page}>
                    ...
                    <View style={{flexDirection: 'row',}}>
                        <View style={styles.sectiontxtborder100}>
                            <Image style={{width: '300px',height:'200px'}} src={VAL_SRFIMGBASE64} />
                    ...
                    <View style={{flexDirection: 'row',}}>
                        <View style={styles.sectiontxtborder50}>
                            <View style={{flexDirection: 'row',}}>
                                <View style={styles.section50}><Image style={{width: '100',height:'50'}} src={VAL_BARCODEBASE64} /></View>
                                <View style={styles.section50}>
                                <Text style={styles.desc}>FOR EMBELLISHMENT</Text>
                                <Text style={styles.desc}>DOC ID : {VAL_SRFIDCLUSTER}{VAL_SRFIDDATE}{VAL_SRFIDSEQ}</Text>
                                </View>
                            </View>
                        </View>
                        <View style={styles.sectiontxtborder50}>
                            <View style={{flexDirection: 'row',}}>
                                <View style={styles.section50}><Image style={{width: '100',height:'50'}} src={VAL_BARCODEBASE64} /></View>
                                <View style={styles.section50}>
                                <Text style={styles.desc}>FOR DYE OR WASH</Text>
                                <Text style={styles.desc}>DOC ID : {VAL_SRFIDCLUSTER}{VAL_SRFIDDATE}{VAL_SRFIDSEQ}</Text>
                                </View>
                            </View>
                        </View> 
