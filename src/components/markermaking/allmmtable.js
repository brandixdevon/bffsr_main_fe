...
const headCells = [
  ...
  { id: 'mm_status', numeric: true, disablePadding: false, label: 'MM STATUS' }
];
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" style={{color:"purple",fontSize:"15px",fontWeight:"bold"}} component="div">
          SRF List For Update Marker Making Details
        </Typography>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    <TableCell align="left">
                      ...
                      <TableCell align="left">{row.mm_status.replace(/"/g, "")}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
