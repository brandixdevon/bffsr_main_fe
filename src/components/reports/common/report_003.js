...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/sampledeliveryfailureforecast`,sendOptions)
    .then(response => response.json())
    .then(data => 
    {
        if(data.Type === "SUCCESS")
        {
          setDS_DATA(data.delivery);
          setDOWNLOADDATA(data.delivery);
        }
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE ROOM DELIVERY FAILURE FORECASTING </Typography>
            </Grid>
            ...
            <ExcelFile filename={"DELIVERY_FAILURE_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="SAMPLE_DELIVERY_DETAILS">
                    <ExcelColumn label="SRF DOC ID" value="srf_doc"/>
                    ...
                    <ExcelColumn label="REQUEST DATE" value="srf_reqdate"/>
                    <ExcelColumn label="PLAN DATE" value="srf_plandate"/>
                    <ExcelColumn label="COMMENTS" value="srfcomments"/>
                </ExcelSheet>
            </ExcelFile>
          ...
          <Grid container spacing={1}>
            ...
            <TableHead>
                <TableRow TableRow>
                    ...
                    <TableCell size="small" style={{width:"20%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>CUSTOMER CATEGORY</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SAMPLE TYPE</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>REQUEST DATE</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                    ...
                    <TableCell size="small" style={{width:"25%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>COMMENTS</Typography>
                    </TableCell>
                </TableRow>
            </TableHead>
            <TableBody>
            {DS_DATA.map((row) => (
                <TableRow key={row.srfdoc}>
                    <TableCell size="small" align="left">{row.srf_doc}</TableCell>
                    ...
                    <TableCell size="small" align="left">{row.srfcomments}</TableCell>
                </TableRow>
                    ))}
        </TableBody>
        </Table>
