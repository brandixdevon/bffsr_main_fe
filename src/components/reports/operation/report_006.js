...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/sewingdetailsbydate`,sendOptions)
    .then(response => response.json())
    .then(data => 
    {
        if(data.Type === "SUCCESS")
        {
          setDS_DATA(data.sewdata);
          setDOWNLOADDATA(data.sewdata);
        }
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE ROOM SEWING OPERATION DETAILS FOR INCENTIVE CALCULATION </Typography>
            </Grid>
            ...
            <ExcelFile filename={"SEW_MO_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="SEWING_MO_DETAILS">
                    ...
                    <ExcelColumn label="SEW START" value="start_time"/>
                    <ExcelColumn label="SEW FINISHED" value="end_time"/>
                </ExcelSheet>
            </ExcelFile>
            ...
            <TableHead>
                <TableRow TableRow>
                    ...
                    <TableCell size="small" style={{width:"15%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SEW START</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"15%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SEW END</Typography>
                    </TableCell>
                </TableRow>
            </TableHead>
            <TableBody>
