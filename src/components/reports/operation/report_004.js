...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/cutdetailsbydate`,sendOptions)
    .then(response => response.json())
    .then(data => 
    {
        if(data.Type === "SUCCESS")
        {
          setDS_DATA(data.cutdata);
          setDOWNLOADDATA(data.cutdata);
        }
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE ROOM CUTTING OPERATION DETAILS FOR INCENTIVE CALCULATION </Typography>
            </Grid>
            ...
            <ExcelFile filename={"CUTTING_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="CUTTING_TEAM_DETAILS">
                    <ExcelColumn label="SRF DOC ID" value="srfdoc"/>
                    <ExcelColumn label="TEAM" value="cut_team"/>
                    <ExcelColumn label="HANDLING" value="cut_handling"/>
                    <ExcelColumn label="METHOD" value="cut_method"/>
                    <ExcelColumn label="START" value="start_time"/>
                    <ExcelColumn label="FINISHED" value="end_time"/>
                    <ExcelColumn label="STYLE" value="style"/>
                    <ExcelColumn label="STYLE DESC" value="styledesc"/>
                    <ExcelColumn label="QTY" value="qty"/>
                    <ExcelColumn label="PERIMETER" value="perimeter"/>
                    <ExcelColumn label="PCS" value="pcs"/>
                    <ExcelColumn label="PLICE" value="plice"/>
                </ExcelSheet>
            </ExcelFile>
          ...
          <Grid container spacing={1}>
            ...
            <TableHead>
                <TableRow TableRow>
                    <TableCell size="small" style={{width:"12%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SRF DOC ID</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>TEAM</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"5%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>HANDLING</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"5%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>METHOD</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>START</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>FINISHED</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>STYLE</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"15%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>STYLE DESC</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"5%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>QTY</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"5%"}} align="left">
            ...
            {DS_DATA.map((row) => (
                <TableRow key={row.srfdoc}>
                    ...
                    <TableCell size="small" align="left">{row.cut_team}</TableCell>
                    <TableCell size="small" align="left">{row.cut_handling}</TableCell>
                    ...
                    <TableCell size="small" align="left">{row.style}</TableCell>
                    <TableCell size="small" align="left">{row.styledesc}</TableCell>
                    <TableCell size="small" align="left">{row.qty}</TableCell>
