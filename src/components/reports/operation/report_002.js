...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/resewingdetailsbydate`,sendOptions)
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE ROOM REWORK SEWING OPERATION DETAILS FOR INCENTIVE CALCULATION </Typography>
            </Grid>
            ...
            <ExcelFile filename={"REWORK_SEW_MO_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="SEWING_MO_DETAILS">
                    ...
                    <ExcelColumn label="REWORK QTY" value="rework_qty"/>
                    <ExcelColumn label="APPROVED QTY" value="qc_accept"/>
                    <ExcelColumn label="START" value="start_time"/>
                    <ExcelColumn label="FINISHED" value="end_time"/>
                    <ExcelColumn label="COMMENT/REMARK" value="rework_remark"/>
                </ExcelSheet>
            </ExcelFile>
          ...
          <Grid container spacing={1}>
            ...
            <TableHead>
                <TableRow TableRow>
                    ...
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>REWORK QTY</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                    ...
                    <TableCell size="small" style={{width:"15%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>REMARK</Typography>
                    </TableCell>
                </TableRow>
            </TableHead>
            <TableBody>
