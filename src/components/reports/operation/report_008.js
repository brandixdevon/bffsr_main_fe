...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/firsthitrate`,sendOptions)
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE ROOM FIRST HIT RATE COUNT </Typography>
            </Grid>
            ...
            <ExcelFile filename={"SR_FIRST_HIT_RATE_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="SRF_DETAILS">
                    ...
                    <ExcelColumn label="TOTAL REQUEST COUNT" value="count"/>
                </ExcelSheet>
            </ExcelFile>
          ...
          <Grid container spacing={1}>
            ...
            <TableHead>
                <TableRow TableRow>
                    ...
                    <TableCell size="small" style={{width:"20%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>TOTAL REQUEST COUNT</Typography>
                    </TableCell>
                </TableRow>
            </TableHead>
            <TableBody>
