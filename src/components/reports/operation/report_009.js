...
const GetData = () => {
  ...
  const sendOptions = {
    ...
    fetch(`http://${apiurl}/reports/sampleturntime`,sendOptions)
        ...
        <Container maxWidth="false" className={classes.container}>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} md={12}>
                <Typography style={{fontSize:15,color:"purple",fontWeight:700,padding:1}} gutterBottom>SAMPLE PROCESSING CYCLE TIME REPORT</Typography>
            </Grid>

            <Grid item xs={6} md={3}>
              <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>Select From Date (SRF Raised Date)</Typography>
            ...
            <Grid item xs={6} md={3}>
              <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>Select To Date (SRF Raised Date)</Typography>
              <MuiPickersUtilsProvider utils={DateFnsUtils}>
            ...
            <ExcelFile filename={"SAMPLE_CYCLE_TIME_DETAILS_"+ new Date().toISOString().slice(0,20)} fileExtension="xlsx" element={<Button variant="contained" style={{color:"white",backgroundColor:"green"}} >Download Excel File</Button>}>
                <ExcelSheet data={DOWNLOADDATA} name="SRF_DETAILS">
                    ...
                    <ExcelColumn label="SRF REQUEST" value="srf_reqdate"/>
                    <ExcelColumn label="PLAN DATE" value="srf_plandate"/>
                    <ExcelColumn label="DISPATCH START DATE" value="dis_start"/>
                </ExcelSheet>
            </ExcelFile>
          ...
          <Grid container spacing={1}>
            ...
            <TableHead>
                <TableRow TableRow>
                    ...
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>FLOORSET</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                    ...
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>ROUTE</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>CURRENT STATUS</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SRF RAISED</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>SRF REQUEST</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"8%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>PLAN DATE</Typography>
                    </TableCell>
                    <TableCell size="small" style={{width:"10%"}} align="left">
                        <Typography variant="subtitle2" style={{"font-weight":"bold"}} gutterBottom>DISPATCH START DATE</Typography>
                    </TableCell>
                </TableRow>
            </TableHead>
            <TableBody>
            {DS_DATA.map((row) => (
                <TableRow key={row.cus_name}>
                    ...
                    <TableCell size="small" align="left">{row.dis_start}</TableCell>
                </TableRow>
                    ))}
        </TableBody>
        </Table>
