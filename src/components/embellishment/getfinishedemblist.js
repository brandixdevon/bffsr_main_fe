...
export default function EnhancedTable() {
  ...
  const FilterSearch = async () => 
  {
    ...
    {
      await fetch(`http://${apiurl}/embellishment/embreadytogo`)
      .then(res => res.json())
      .then(response => {
        setDATASET(response.embreadytogo);
      })
    ...
    else
    {
                ...
                await fetch(`http://${apiurl}/embellishment/pendingembreadytogofilter`,sendOptions)
                .then(res => res.json())
                .then(response => {
  ...
  const handleClosecomment = () => 
  {
   ...
   useEffect(() => {
    fetch(`http://${apiurl}/embellishment/embreadytogo`)
      .then(res => res.json())
      .then(response => {
        setDATASET(response.embreadytogo);
      })
  ...
  return (
    <div className={classes.root}>
      ...
      <div style={{width:"65%"}}>
          ...
          All Pending SRF List For Embellishment Sending to Print
          </Typography>
      </div>
