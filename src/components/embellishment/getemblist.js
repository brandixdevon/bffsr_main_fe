...
export default function EnhancedTable() {
  ...
  const FilterSearch = async () => 
  {
    ...
    {
      await fetch(`http://${apiurl}/embellishment/pendingemb`)
      .then(res => res.json())
      .then(response => {
    ...
    else
    {
                ...
                await fetch(`http://${apiurl}/embellishment/pendingemblistfilter`,sendOptions)
                .then(res => res.json())
                .then(response => {
      ...
      body: JSON.stringify({
          ...
          "proelmid":HoldElmID
            ...
            .then(data => 
            {
                ...
                fetch(`http://${apiurl}/embellishment/pendingemb`)
                .then(res => res.json())
                .then(response => {
                  setDATASET(response.embellishment);
                })
  ...
  return (
    <div className={classes.root}>
      ...
      <div style={{width:"65%"}}>
          ...
          All Pending SRF List For Embellishment Sending
          </Typography>
      </div>
                    ...
                    <TableCell align="left">
                        ...
                        <Tooltip title="Update Details">
                          <IconButton aria-label="edit" component={ Link } 
                              to={"/embupdate/" + row.srf_id + "/" + row.proelmid}
                              variant="contained"
                              color="default"
                              size="small">
                      ...
                      <TableCell style={{fontSize:"13px"}} align="left">{row.emb_status}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
