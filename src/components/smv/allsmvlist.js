...
import DataTable  from './allsmvtable';
...
export default function Allsrf() {
  ...
  function GetData ()
  {
    ...
    {
        Swal.fire({  title: 'Error!',  text: 'Please Select SMV Release Status.',  icon: 'error',  confirmButtonText: 'OK'});
        return;
    }
  ...
  fetch(`http://${apiurl}/filter/customsrflist`,sendOptions)
  .then(res => res.json())
  .then(response => {
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth={false} className={classes.container}>
          <Grid  style={{backgroundColor: 'white'}} container spacing={1}>
            ...
            <Grid item md={6}>
            <Typography variant="subtitle2" gutterBottom>SMV Release Status</Typography>
            <MultiSelect
                  overrideStrings={{"allItemsAreSelected": "All SMV Release Status are selected.","selectAll": "Select All Status"}}
