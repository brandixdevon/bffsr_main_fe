...
import DataTable  from './allsttable';
      ...
      <main className={classes.content}>
        ...
        <Container maxWidth={false} className={classes.container}>
          <Grid  style={{backgroundColor: 'white'}} container spacing={1}>
            ...
            <Grid item md={6}>
            <Typography variant="subtitle2" gutterBottom>Stores Status</Typography>
            <MultiSelect
                  overrideStrings={{"allItemsAreSelected": "All Stores Status are selected.","selectAll": "Select All Status"}}
