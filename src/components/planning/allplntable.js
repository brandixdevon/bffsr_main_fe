...
const headCells = [
  ...
  { id: 'pl_status', numeric: true, disablePadding: false, label: 'PLANNING STATUS' }
];
    ...
    >
      ...
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h6" id="tableTitle" style={{color:"purple",fontSize:"15px",fontWeight:"bold"}} component="div">
          SRF List For Update Planning Details
        </Typography>
      )}
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    <TableCell align="left">
                      ...
                      <TableCell align="left">{row.pl_status.replace(/"/g, "")}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
